        ...
        <div class="row">
            <div class="col-md-12" style="border: 1px solid #CCC;">
                ...
                <?php
                    ...
                    //echo '<input type="hidden" name="videoid" class="form-control" value=https://www.youtube.com/
                    //watch?v='.$item->id->videoId.'&type=Download'.'>';
                    /*<button type="submit" name="type" id="type" class="btn btn-info text-center"> Download </button> */


                     echo '<input type="hidden" name="videoid" id="videoid" class="form-control" value="https://www.youtube.com/watch?v='.$item->id->videoId.' ">';
                        
                     //echo '<input type="submit" id="type" name="type" class="btn btn-info text-center" />';
                     echo '<button type="submit" name="type" id="type" class="btn btn-info text-center"> Download </button>';
                     echo '</form> <br> </div>';
